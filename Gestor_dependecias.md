...
- Eficiencia: Deben de ser rapidos a la hora de ejecutar las tareas.
- Madurez: Se valoran mas los gestores que llevan mas tiempo activos ya que suelen ser más confiables, tienen una comunidad mayor y cuentan con mayor documentación y soporte
## Opciones
...
- [Conda](https://docs.conda.io/projects/conda/en/latest/user-guide/getting-started.html): Conda es una herramienta de gestión de paquetes y entornos proporcionada por Anaconda. Puedes usar conda para crear un nuevo entorno virtual y luego agregar/administrar sus dependencias. Es mas complejo de usar y no esta enfocado a python.
## Elección
Las tres opciones son actualizadas de forma frecuente. Conda es mas lento que las otras opciones por lo que se descarta. Entre Uv y Poetry he escogido Poetry ya que tiene una mayor madurez que Uv que fue creado hace no mucho.

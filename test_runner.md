...
- Extensión de los informes: Se valorara que los resultados de las pruebas sean detallados, proporcionando información útil que facilite la identificación de fallos y su resolución.

...
- Eficiencia: Se valorara que el test runner realice sus funciones de forma rápida y eficiente.
## Opciones
...
## Elección
Nose2 es el que tiene el peor mantenimiento de los tres por lo que lo descarto. Entre Pytest y Unittest he elegido Pytest debido recibe actualizaciones de forma frecuente, ademas es un test runner rápido y eficiente.
